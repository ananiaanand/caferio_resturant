...
class _ManagerSalesScreenState extends State<ManagerSalesScreen>
  ...
  final List<Map<String, dynamic>> _topItems = [
    {'name': 'Nadan Beef Roast', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Kerala Parotta', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Chicken 65', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Fish Curry', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Egg Fried Rice', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Mutton Biryani', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
    {'name': 'Prawn Masala', 'sold': 0, 'revenue': '₹0', 'fraction': 0.0},
  ];

  final List<Map<String, dynamic>> _transactions = [
    {'id': '#4821', 'time': '12:34 PM', 'items': 'Beef Roast, Parotta x2', 'amount': '₹0', 'status': 'paid'},
    {'id': '#4820', 'time': '12:18 PM', 'items': 'Chicken 65, Rice', 'amount': '₹0', 'status': 'paid'},
    {'id': '#4819', 'time': '12:02 PM', 'items': 'Fish Curry, Naan x3', 'amount': '₹0', 'status': 'paid'},
    {'id': '#4818', 'time': '11:47 AM', 'items': 'Mutton Biryani', 'amount': '₹0', 'status': 'paid'},
    {'id': '#4817', 'time': '11:30 AM', 'items': 'Prawn Masala, Rice', 'amount': '₹0', 'status': 'pending'},
    {'id': '#4816', 'time': '11:15 AM', 'items': 'Parotta x4, Egg Curry', 'amount': '₹0', 'status': 'paid'},
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _buildKpiCard('Total Revenue', '₹0', Icons.payments_outlined, AppColors.primary)),
              const SizedBox(width: 12),
              Expanded(child: _buildKpiCard('Orders', '0', Icons.receipt_long_outlined, AppColors.secondary)),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(child: _buildKpiCard('Avg Order', '₹0', Icons.shopping_basket_outlined, const Color(0xFF575757))),
              const SizedBox(width: 12),
              Expanded(child: _buildKpiCard('Growth', '0%', Icons.trending_up, Colors.green)),
            ],
          ),
              ...
              children: [
                Expanded(
                  child: Row(
                    ...
                    children: [
                      _buildBar(0.0, '11AM', false),
                      _buildBar(0.0, '12PM', false),
                      _buildBar(0.0, '1PM', false),
                      _buildBar(0.0, '2PM', false),
                      _buildBar(0.0, '5PM', false),
                      _buildBar(0.0, '7PM', false),
                      _buildBar(0.0, '9PM', false),
                    ],
                  ),
                ),
              ],
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('0kg / week', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const SizedBox(height: 8),
                      LinearProgressIndicator(value: 0.0, backgroundColor: AppColors.surfaceContainerHighest,
                          valueColor: const AlwaysStoppedAnimation<Color>(AppColors.primary), minHeight: 6, borderRadius: BorderRadius.circular(4)),
                      const SizedBox(height: 6),
                      const Text('+0% vs last week', style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 11)),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('0% Reliable', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const SizedBox(height: 8),
                      LinearProgressIndicator(value: 0.0, backgroundColor: AppColors.surfaceContainerHighest,
